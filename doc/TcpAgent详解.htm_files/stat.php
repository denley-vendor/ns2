...
var data='&r='+escape(document.referrer.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.30835000 1242970176';
var cnzz_a=gc_cnzz("cnzz_a1236358");
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=1236358" target=_blank title="Õ¾³¤Í³¼Æ"><img border=0 hspace=0 vspace=0 src="http://icon.cnzz.com/pic.gif" ></a>');
document.write('<img src="http://b74.cnzz.com/stat.htm?id=1236358'+data+'" border=0 width=0 height=0>');
var et=(86400-ed.getHours()*3600-ed.getMinutes()*60-ed.getSeconds());
ed.setTime(now+1000*(et-ed.getTimezoneOffset()*60));
document.cookie="cnzz_a1236358="+cnzz_a+";expires="+ed.toGMTString()+ "; path=/";
document.cookie="vw1236358="+escape(vw)+ ";expires="+ed.toGMTString()+";path=/";
document.cookie="sin1236358="+escape(sin)+ ";expires="+ed.toGMTString()+";path=/";
